...
export default function LandingPage() {
    ...
    useEffect(() => {
        ...
        axios.get('http://202.30.29.204:8080/notices/latest') // 공지사항 API 엔드포인트를 여기에 입력
          .then(response => {
        ...
        <div className="flex h-screen w-screen flex-col">
            ...
            <div className="flex flex-col w-full h-full justify-center my-2">
                ...
                <div className="flex flex-row gap-1 w-5/6 h-1/5 m-auto">
                    <Link to="https://instagram.com/ajou.life_?igshid=MjEwN2IyYWYwYw==" className="flex-1 bg-[#b1d5ff] container rounded-lg my-2 mx-1 pt-5 text-center">
                    ...
                    <Link to="https://www.facebook.com/ajou.life.2023?mibextid=LQQJ4d" className="flex-1 bg-[#b1d5ff] container rounded-lg my-2 mx-1 pt-5 text-center">
